				...
				<div class="flex flex-1 md:gap-1 lg:gap-2">
					...
					<div class="flex items-center gap-2 lg:hidden">
						...
						<a href="/docs/changelog" class="link link-hover font-mono text-xs text-opacity-50 "
							><div data-tip="Changelog" class="tooltip tooltip-bottom">2.31.0</div></a
						>
					</div>
									...
									>
										<div class="flex gap-2 p-3">
											<svg
												...
												viewBox="0 0 512 512"
												><path d="M96,208H48a16,16,0,0,1,0-32H96a16,16,0,0,1,0,32Z" /><line
													x1="90.25"
													y1="90.25"
													x2="124.19"
													y2="124.19"
		...
		<div class="p-6 pb-16">
			<div class="flex flex-col-reverse justify-between gap-6 xl:flex-row">
				<div class="prose w-full max-w-4xl flex-grow">
					<h1>Drawer</h1>
					<p>
						Drawer is a grid layout that can show/hide a sidebar on the left or right side of the
						page.
					</p>
					<div class="not-prose mt-6 mb-10 overflow-x-auto">
						<table class="table-compact table w-full">
							...
							<tbody>
								<tr
									><th class="font-normal"><span class="font-mono lowercase">drawer</span></th>
									<td><span class="badge badge-sm badge-ghost w-20">Component</span> </td>
									<td>Container element</td>
								</tr><tr
									><th class="font-normal"
										><span class="font-mono lowercase">drawer-toggle</span></th
									>
									<td><span class="badge badge-sm badge-ghost w-20">Component</span> </td>
									<td>For checkbox element that controls the drawer</td>
								</tr><tr
									><th class="font-normal"
										><span class="font-mono lowercase">drawer-content</span></th
									>
									<td><span class="badge badge-sm badge-ghost w-20">Component</span> </td>
									<td>The content container</td>
								</tr><tr
									><th class="font-normal"><span class="font-mono lowercase">drawer-side</span></th>
									<td><span class="badge badge-sm badge-ghost w-20">Component</span> </td>
									<td>The sidebar container</td>
								</tr><tr
									><th class="font-normal"
										><span class="font-mono lowercase">drawer-overlay</span></th
									>
									<td><span class="badge badge-sm badge-ghost w-20">Component</span> </td>
									<td>The label covers the content when drawer is open</td>
								</tr><tr
									><th class="font-normal"
										><span class="font-mono lowercase">drawer-mobile</span></th
									>
									<td>
										<div
											class="tooltip tooltip-right cursor-help"
											data-tip="Changes the style of a component"
										>
									...
									><th class="font-normal"><span class="font-mono lowercase">drawer-end</span></th>
									<td>
										<div
											class="tooltip tooltip-right cursor-help"
											data-tip="Changes the style of a component"
					...
					<p>
						Drawer sidebar can be visible by default on large screens or it can be toggleable on
						both large and small screens.
					</p>
					<p>Drawer tags structure:</p>
					<pre class="language-js"><code class="language-js"
							><span class="token punctuation">.</span>drawer <span class="token comment"
								>// The root container</span
							>
      ├── <span class="token punctuation">.</span>drawer<span class="token operator">-</span
							>toggle <span class="token comment"
								>// A hidden checkbox to toggle the visibility of the sidebar</span
							>
      ├── <span class="token punctuation">.</span>drawer<span class="token operator">-</span
							>content <span class="token comment">// All your page content goes here</span>
      │    ├── <span class="token comment">// navbar</span>
      │    ├── <span class="token comment">// content</span>
      │    └── <span class="token comment">// footer</span>
      └── <span class="token punctuation">.</span>drawer<span class="token operator">-</span
							>side <span class="token comment">// Sidebar wrapper</span>
           ├── <span class="token punctuation">.</span>drawer<span class="token operator">-</span
							>overlay <span class="token comment"
								>// A dark overlay that covers the whole page when the drawer is open</span
							>
           └── <span class="token comment">// Sidebar content (menu or anything)</span></code
						></pre>
					<p>
						You can check/uncheck the checkbox using JavaScript or using <code>&lt;label&gt;</code> tag.
					</p>
					<div class="component-preview not-prose text-base-content my-4 max-w-4xl" id="drawer">
						<div class="pb-2 text-sm font-bold">
							<a class="opacity-20 hover:opacity-60" href="#drawer">#</a>
							<span class="component-preview-title">Drawer</span>
						</div>
						<div class="grid">
							<div class="tabs z-10 -mb-px">
								<button class="tab tab-lifted tab-active [--tab-bg:hsl(var(--b2))]">Preview</button>
								...
								>
									<div class="drawer h-56 rounded">
										...
										<div class="drawer-side">
											...
											<ul
												class="menu p-4 overflow-y-auto w-60 md:w-80 bg-base-100 text-base-content"
											>
					...
					<div
						class="component-preview not-prose text-base-content my-4 max-w-4xl"
						id="drawer-for-mobile--fixed-sidebar-for-desktop"
					>
						<div class="pb-2 text-sm font-bold">
							<a
								class="opacity-20 hover:opacity-60"
								href="#drawer-for-mobile--fixed-sidebar-for-desktop">#</a
							>
							<span class="component-preview-title"
								>Drawer for mobile + fixed sidebar for desktop</span
							>
						</div>
						<div class="pb-2 text-xs opacity-70">
							Drawer is always open on desktop size. Drawer can be toggled on mobile size. Resize
							the browser to see toggle button on mobile size
						</div>
						<div class="grid">
							<div class="tabs z-10 -mb-px">
								<button class="tab tab-lifted tab-active [--tab-bg:hsl(var(--b2))]">Preview</button>
					...
					<div
						class="component-preview not-prose text-base-content my-4 max-w-4xl"
						id="navbar-menu-for-desktop--sidebar-drawer-for-mobile"
					>
						<div class="pb-2 text-sm font-bold">
							<a
								class="opacity-20 hover:opacity-60"
								href="#navbar-menu-for-desktop--sidebar-drawer-for-mobile">#</a
							>
							<span class="component-preview-title"
								>Navbar menu for desktop + sidebar drawer for mobile</span
							>
						</div>
					...
					<div
						class="component-preview not-prose text-base-content my-4 max-w-4xl"
						id="drawer-that-opens-from-right-side-of-page"
					>
						<div class="pb-2 text-sm font-bold">
							<a
								class="opacity-20 hover:opacity-60"
								href="#drawer-that-opens-from-right-side-of-page">#</a
							>
							<span class="component-preview-title">Drawer that opens from right side of page</span>
						</div>
						<div class="grid">
							<div class="tabs z-10 -mb-px">
								<button class="tab tab-lifted tab-active [--tab-bg:hsl(var(--b2))]">Preview</button>
					...
					<div class="not-prose pb-10">
						...
						<div class="flex justify-between">
							...
							<div>
								<a href="/components/footer" class="btn btn-sm md:btn-md gap-2 normal-case lg:gap-3"
								...
								<div class="flex items-center gap-2">
									...
									<div>
										...
										<a
											...
											rel="noopener"
											class="link"
											href="https://github.com/saadeghi/daisyui/discussions">ask the community</a
										>
									</div>
								</div>
								<div class="flex items-center gap-2">
									...
									<div>
										...
										<a
											...
											rel="noopener"
											class="link"
											href="https://github.com/saadeghi/daisyui/issues?q=Drawer"
								...
								<div class="flex items-center gap-2">
									...
									<div>
										<a
											...
											rel="noopener"
											class="link"
											href="https://github.com/saadeghi/daisyui/blob/master/src/docs/src/routes/components/drawer.svelte.md?plain=1"
						...
						<div class="flex flex-col gap-2 pb-6">
							...
							<div class="flex gap-2 flex-col sm:flex-row">
								<a
									...
									target="_blank"
									rel="nofollow"
									class="flex w-[130px] flex-col items-center rounded bg-base-100 border-base-100 border-base-content/10 hover:border-base-content/20 border"
									><svg
										class="fill-base-content mt-2 mb-1"
										width="110"
										height="20"
										viewBox="0 0 128 22"
										fill="none"
							...
							<a
								...
								target="_blank"
								rel="nofollow"
								class="group link link-hover text-xs opacity-80"
								>Become a sponsor
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
	...
	<div class="drawer-side" style="scroll-behavior: smooth; scroll-padding-top: 5rem;">
		...
		<aside class="bg-base-200 w-80">
			...
			<ul class="menu menu-compact flex flex-col p-0 px-4">
				...
				<li>
					<a sveltekit:prefetch href="/docs/use" id="" class="flex gap-4   "
						><span class="flex-none"
							><svg
								width="24"
								height="24"
				...
				<li>
					<a sveltekit:prefetch href="/docs/customize" id="" class="flex gap-4   "
						><span class="flex-none"
							><svg
								width="24"
								height="24"
				...
				<li>
					<a sveltekit:prefetch href="/docs/config" id="" class="flex gap-4   "
						><span class="flex-none"
							><svg
								width="24"
								height="24"
				...
				<li>
					<a sveltekit:prefetch href="/docs/colors" id="" class="flex gap-4   "
						><span class="flex-none"
							><svg
								width="24"
								height="24"
				...
				<li>
					<a sveltekit:prefetch href="/docs/themes" id="" class="flex gap-4   "
						><span class="flex-none"
							><svg
								width="24"
								height="24"
				...
				<li>
					<a sveltekit:prefetch href="/theme-generator" id="" class="flex gap-4   "
						><span class="flex-none"
							><svg
								width="24"
								height="24"
								...
								class="w-6 h-6 fill-current"
								viewBox="0 0 512 512"
								><title>ionicons-v5-m</title><path
									d="M96,208H48a16,16,0,0,1,0-32H96a16,16,0,0,1,0,32Z"
								/><line x1="90.25" y1="90.25" x2="124.19" y2="124.19" /><path
									d="M124.19,140.19a15.91,15.91,0,0,1-11.31-4.69L78.93,101.56a16,16,0,0,1,22.63-22.63l33.94,33.95a16,16,0,0,1-11.31,27.31Z"
								/><path
									d="M192,112a16,16,0,0,1-16-16V48a16,16,0,0,1,32,0V96A16,16,0,0,1,192,112Z"
								/><line x1="293.89" y1="90.25" x2="259.95" y2="124.19" /><path
				...
				<li>
					<a sveltekit:prefetch href="/docs/layout-and-typography" id="" class="flex gap-4   "
						><span class="flex-none"
							><svg
								width="24"
								height="24"
			...
			<ul class="menu menu-compact flex flex-col p-0 px-4">
				...
				<li>
					<a sveltekit:prefetch href="/components/button" id="" class="flex gap-4   ">
						<span class="flex-1">Button</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/dropdown" id="" class="flex gap-4   ">
						<span class="flex-1">Dropdown</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/modal" id="" class="flex gap-4   ">
						<span class="flex-1">Modal</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/swap" id="" class="flex gap-4   ">
			...
			<ul class="menu menu-compact flex flex-col p-0 px-4">
				...
				<li>
					<a sveltekit:prefetch href="/components/alert" id="" class="flex gap-4   ">
						<span class="flex-1">Alert</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/avatar" id="" class="flex gap-4   ">
						<span class="flex-1">Avatar</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/badge" id="" class="flex gap-4   ">
						<span class="flex-1">Badge</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/card" id="" class="flex gap-4   ">
						<span class="flex-1">Card</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/carousel" id="" class="flex gap-4   ">
						<span class="flex-1">Carousel</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/collapse" id="" class="flex gap-4   ">
						<span class="flex-1">Collapse</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/countdown" id="" class="flex gap-4   ">
						<span class="flex-1">Countdown</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/kbd" id="" class="flex gap-4   ">
						<span class="flex-1">Kbd</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/progress" id="" class="flex gap-4   ">
						<span class="flex-1">Progress</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/radial-progress" id="" class="flex gap-4   ">
						<span class="flex-1">Radial progress</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/stat" id="" class="flex gap-4   ">
						<span class="flex-1">Stat</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/table" id="" class="flex gap-4   ">
						<span class="flex-1">Table</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/tooltip" id="" class="flex gap-4   ">
			...
			<ul class="menu menu-compact flex flex-col p-0 px-4">
				...
				<li>
					<a sveltekit:prefetch href="/components/checkbox" id="" class="flex gap-4   ">
						<span class="flex-1">Checkbox</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/input" id="" class="flex gap-4   ">
						<span class="flex-1">Text input</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/radio" id="" class="flex gap-4   ">
						<span class="flex-1">Radio</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/range" id="" class="flex gap-4   ">
						<span class="flex-1">Range</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/rating" id="" class="flex gap-4   ">
						<span class="flex-1">Rating</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/select" id="" class="flex gap-4   ">
						<span class="flex-1">Select</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/textarea" id="" class="flex gap-4   ">
						<span class="flex-1">Textarea</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/toggle" id="" class="flex gap-4   ">
			...
			<ul class="menu menu-compact flex flex-col p-0 px-4">
				...
				<li>
					<a sveltekit:prefetch href="/components/artboard" id="" class="flex gap-4   ">
						<span class="flex-1">Artboard</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/button-group" id="" class="flex gap-4   ">
						<span class="flex-1">Button group</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/divider" id="" class="flex gap-4   ">
				...
				<li>
					<a sveltekit:prefetch href="/components/footer" id="" class="flex gap-4   ">
						<span class="flex-1">Footer</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/hero" id="" class="flex gap-4   ">
						<span class="flex-1">Hero</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/indicator" id="" class="flex gap-4   ">
						<span class="flex-1">Indicator</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/input-group" id="" class="flex gap-4   ">
						<span class="flex-1">Input group</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/mask" id="" class="flex gap-4   ">
						<span class="flex-1">Mask</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/stack" id="" class="flex gap-4   ">
						<span class="flex-1">Stack</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/toast" id="" class="flex gap-4   ">
			...
			<ul class="menu menu-compact flex flex-col p-0 px-4">
				...
				<li>
					<a sveltekit:prefetch href="/components/breadcrumbs" id="" class="flex gap-4   ">
						<span class="flex-1">Breadcrumbs</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/bottom-navigation" id="" class="flex gap-4   ">
						<span class="flex-1">Bottom navigation</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/link" id="" class="flex gap-4   ">
						<span class="flex-1">Link</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/menu" id="" class="flex gap-4   ">
						<span class="flex-1">Menu</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/navbar" id="" class="flex gap-4   ">
						<span class="flex-1">Navbar</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/pagination" id="" class="flex gap-4   ">
						<span class="flex-1">Pagination</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/steps" id="" class="flex gap-4   ">
						<span class="flex-1">Steps</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/tab" id="" class="flex gap-4   ">
			...
			<ul class="menu menu-compact flex flex-col p-0 px-4">
				...
				<li>
					<a sveltekit:prefetch href="/components/mockup-code" id="" class="flex gap-4   ">
						<span class="flex-1">Code</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/mockup-phone" id="" class="flex gap-4   ">
						<span class="flex-1">Phone</span>
					</a>
				</li>
				<li>
					<a sveltekit:prefetch href="/components/mockup-window" id="" class="flex gap-4   ">
